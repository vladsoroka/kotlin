...
public class QuickFixMultiModuleTestGenerated extends AbstractQuickFixMultiModuleTest {
    ...
    public void testAllFilesPresentInMultiModuleQuickFix() throws Exception {
        KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/multiModuleQuickFix"), Pattern.compile("^([^\\.]+)$"), TargetBackend.ANY, false, "overload");
    }
    ...
    public void testOverload() throws Exception {
        String fileName = KotlinTestUtils.navigationMetadata("idea/testData/multiModuleQuickFix/overload/");
        doTest(fileName);
    }
